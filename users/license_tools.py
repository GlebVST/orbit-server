    ...
    def preprocessData(self):
        ...
        for d in self.data:
            ...
            if key:
                ...
                if is_match:
                    continue
                # key exists, but no exact match on expireDate
                sl = userDict[key][0] # latest expireDate
                ...
                if not ugs.exists():
                    ...
                    # renewal or edit-in-place (decision is made by serializer based on expireDate)
