# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-28 06:13
...
class Migration(migrations.Migration):
    ...
    replaces = [('users', '0001_initial'), ('users', '0002_auto_20161128_0610')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(null=True, upload_to='entries/%Y/%m/%d')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('cmeTags', models.ManyToManyField(related_name='profiles', to=b'users.CmeTag')),
                ('degrees', models.ManyToManyField(to=b'users.Degree')),
                ('specialties', models.ManyToManyField(to=b'users.PracticeSpecialty')),
            ],
        ),
        migrations.CreateModel(
            name='UserFeedback',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isDiagnosis', models.BooleanField(default=True)),
                ('isPlanUnchanged', models.BooleanField(default=True)),
            ],
        ),
        migrations.CreateModel(
            name='ExBrowserCme',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(related_name='srcmes', to=b'users.CmeTag')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AlterModelOptions(
            name='cmetag',
            options={'verbose_name_plural': 'CME Tags'},
        ),
        migrations.AlterModelOptions(
            name='entry',
        ...
        migrations.AlterModelOptions(
            name='practicespecialty',
            options={'verbose_name_plural': 'Practice Specialties'},
        ),
        migrations.AlterModelOptions(
            name='userfeedback',
        ...
        migrations.RemoveField(
            model_name='browsercme',
            name='isPlanUnchanged',
        ),
        migrations.AddField(
            model_name='browsercme',
            name='planEffect',
            field=models.IntegerField(choices=[(0, 'No change'), (1, 'Change')], default=0),
        ),
        migrations.AddField(
            model_name='browsercme',
            name='purpose',
            field=models.IntegerField(choices=[(0, 'DX'), (1, 'TX')], default=0, help_text='DX = Diagnosis. TX = Treatment'),
        ),
