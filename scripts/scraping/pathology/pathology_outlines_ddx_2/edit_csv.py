...
write_csv = csv.writer(open("all_ddx_links_pathology_outlines_09_20_2020_v3.csv", "w"), quoting=csv.QUOTE_ALL)
header = ["Page Url", "Page Title", "Bullet text", "Link"]
write_csv.writerow(header)

with open("all_ddx_links_pathology_outlines_09_20_2020.csv", "r") as infile:
