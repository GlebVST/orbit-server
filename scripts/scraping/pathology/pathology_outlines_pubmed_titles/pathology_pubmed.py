...
def extractDdx(page_url_deque, file_pointer, proxy_pool, error_file_pointer):
    ...
    pubmed = None
    for b in bold_tags:
        if b.text[:13].lower() == "pubmed search":
            pubmed = b
            break
    ...
    pubmed_title = ""
    if len(tag.text) > 0:
       pubmed_title = tag.text

    f.writerow({"Page Url": article_url, "Page Title": article_title,
                "Pubmed Title": pubmed_title})
...
if __name__=="__main__":
    ...
    proxies = ['83.97.23.90:18080', '83.97.23.90:18080', '95.174.67.50:18080']#['216.162.88.226:8080', '83.97.23.90:18080', '95.174.67.50:18080']#['198.17.32.109', '95.174.67.50:18080', '168.169.96.14:8080']#'212.87.220.2:3128', ['81.201.60.130:80']#['198.50.163.192:3129']#['144.217.101.245:3129']#['51.75.162.18:9999']
