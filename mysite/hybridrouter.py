# coding:utf-8
# https://bitbucket.org/hub9/django-hybrid-router/src/master/hybridrouter.py
# https://stackoverflow.com/questions/18817988/using-django-rest-frameworks-browsable-api-with-apiviews
...
class HybridRouter(routers.DefaultRouter):
    ...
    def add_api_view(self, urlpattern):
        """Args:
            urlpattern: django.urls.resolvers.URLPattern instance with name specified!
        This adds a new key to api_view_urls dict using url.name
        """
        self._api_view_urls[urlpattern.name] = urlpattern
        ...
        class APIRootView(views.APIView):
            ...
            def get(self, request, *args, **kwargs):
                ...
                for api_view_key in api_view_urls.keys():
                    urlpattern = api_view_urls[api_view_key] # URLPattern instance added via add_api_view
                    regex = urlpattern.pattern.regex # e.g. re.compile(r'^ss-logout/?$', re.UNICODE)
                    if regex.groups == 0:
